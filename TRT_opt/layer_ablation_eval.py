#!/usr/bin/env python3
"""
layer_ablation_eval.py  v4
逐层消融精度敏感层定位 (ONNXRuntime + COCO mAP)
...
DEFAULT_CONFIG = {
    ...
    "images_dir": "/root/my_FILE/my_FILE/CV_yolov8/datasets/Data_DeepPCB_YOLO/images/test",
    "ann_json": "/root/my_FILE/my_FILE/CV_yolov8/datasets/Data_DeepPCB_YOLO/images/test_coco.json",
    "img_size": 640,
    "conf_thres": 0.001,
    "iou_thres": 0.65,
    "max_det": 300,
