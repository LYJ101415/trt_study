...
if __name__ == "__main__":
    ...
    ap.add_argument("--images", default="/root/autodl-tmp/datasets/Data_DeepPCB_YOLO/images/test")
    ap.add_argument("--ann", default="/root/autodl-tmp/datasets/Data_DeepPCB_YOLO/images/test_coco.json")
