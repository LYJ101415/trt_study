...
def check_with_onnxruntime(onnx_path, src_onnx, conf=0.45, iou=0.65):
    ...
    sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "dependency_file"))
    ...
    img = cv2.imread('/root/autodl-tmp/datasets/Data_DeepPCB_YOLO/images/test/00041200.jpg')
