...
sys.path.insert(0, str(Path(__file__).resolve().parents[2]))   # TRT_inferce/
...
def main():
    ...
    ap.add_argument("--source", default="/root/my_FILE/my_trt_FILE/datasets/Data_DeepPCB_YOLO/images/test",
                    help="图片路径 / 文件夹")
    ...
    ap.add_argument("--consumers", type=int, default=2, help="结果消费线程数 (默认 2, save 时调大)")
    args = ap.parse_args()
