...
sys.path.insert(0, str(Path(__file__).resolve().parents[3]))   # TRT_inferce/
...
def main():
    ...
    ap.add_argument("--source", default="/root/my_FILE/datasets/Data_DeepPCB_YOLO/images/test_scaled",
                    help="图片文件夹 / 视频路径")
